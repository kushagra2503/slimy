...
You can contribute in many ways: writing code, improving documentation, reporting bugs, requesting features, or creating tutorials and blog posts. Every contribution, large or small, helps make Slimy better.
...
Please submit all translations to [Crowdin](https://crowdin.com/project/slimy). New strings added to the `dev` branch from code changes will sync automatically to Crowdin, and Crowdin will automatically open a new PR with translations to allow us to integrate them.
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/{your-username}/Slimy.git
   cd Slimy
   ```
...
- Join our [community Discord server](https://discord.com/servers/slimy-1269588937320566815)

---

Thank you for contributing to Slimy! Your efforts help make this project better for everyone. 🎉
