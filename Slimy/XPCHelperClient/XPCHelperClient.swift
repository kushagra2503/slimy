...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "com.slimy.app.SlimyXPCHelper"
    
    private var remoteService: RemoteXPCService<SlimyXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<SlimyXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<SlimyXPCHelperProtocol>(
            connection: conn,
            remoteInterface: SlimyXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<SlimyXPCHelperProtocol>? {
        remoteService
    }
