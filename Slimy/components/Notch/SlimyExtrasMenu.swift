...
struct SlimyExtrasMenu : View {
    @ObservedObject var vm: SlimyViewModel
    ...
    var github: some View {
        SlimyLargeButtons(
            action: {
                if let url = URL(string: "https://github.com/Slimy/Slimy") {
